...
async function snapshot(){
 ...
 return {
  ...
  auditEvents:auditRows.map(a=>({id:String(a.id),patientId:a.patient_id?String(a.patient_id):"",submissionId:a.submission_id?String(a.submission_id):undefined,action:String(a.action),actor:String(a.actor),timestamp:String(a.created_at),details:String(a.details||"")})),
